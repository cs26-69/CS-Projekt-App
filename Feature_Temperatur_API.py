...
def hole_durchschnittstemperatur(ort, start_datum, end_datum):
    ...
    #   2. Fuer jedes der letzten 5 Jahre (bestimmte Variable) die Tagesmittel-Temperaturen
    ...
    #
    # Erwartetes Datumsformat: "DD.MM.YYYY" (z.B. "01.05.2026")
    ...
    # Die Datums-Strings ("DD.MM.YYYY") in echte Datum-Objekte umwandeln.
    ...
    for n in range(1, ANZAHL_JAHRE + 1):
        ...
        # Beispiel: aus 01.05.2026 wird nacheinander 01.05.2025,
        # 01.05.2024, 01.05.2023, 01.05.2022, 01.05.2021.
        try:
        ...
        # - start_date/end_date: der Zeitraum im Referenzjahr. Die API
        #   erwartet das Datum im Format YYYY-MM-DD, darum wandeln wir
        #   es hier mit strftime() entsprechend um.
...
def hole_temperaturen_batch_pro_jahr(orte, start_datum, end_datum):
    ...
    #
    # Open-Meteo akzeptiert mehrere Koordinaten in einem
    ...
    #
    # Hinweis: Geocoding muss trotzdem pro Ort gemacht werden,
...
if __name__ == "__main__":
    ...
    temperatur = hole_durchschnittstemperatur("Madrid", "01.05.2026", "10.05.2026")
